	...
	if (directory <> "" And Not oFilesys.FolderExists(directory)) then
		...
		if (dfi.TotalFiles = 0) then
			...
			if dfi.LargestFileSizeTB > 1.0 then
				wscript.echo("Message Newest file: " & dfi.NewestFileNameDir  & "\" & dfi.NewestFileName & " (" & minutesOld & " minutes old) -- Largest File: " & dfi.LargestFileNameDir  & "\" & dfi.LargestFileName & " (" & dfi.LargestFileSizeMB & "MB)")
			elseif dfi.LargestFileSizeGB > 1.0 then
				wscript.echo("Message Newest file: " & dfi.NewestFileNameDir  & "\" & dfi.NewestFileName & " (" & minutesOld & " minutes old) -- Largest File: " & dfi.LargestFileNameDir  & "\" & dfi.LargestFileName & " (" & dfi.LargestFileSizeGB & "GB)")
			elseif dfi.LargestFileSizeMB > 1.0 then
				wscript.echo("Message Newest file: " & dfi.NewestFileNameDir  & "\" & dfi.NewestFileName & " (" & minutesOld & " minutes old) -- Largest File: " & dfi.LargestFileNameDir  & "\" & dfi.LargestFileName & " (" & dfi.LargestFileSizeMB & "MB)")
			elseif dfi.LargestFileSizeKB > 1.0 then
				wscript.echo("Message Newest file: " & dfi.NewestFileNameDir  & "\" & dfi.NewestFileName & " (" & minutesOld & " minutes old) -- Largest File: " & dfi.LargestFileNameDir  & "\" & dfi.LargestFileName & " (" & dfi.LargestFileSizeKB & "KB)")
			else
				wscript.echo("Message Newest file: " & dfi.NewestFileNameDir  & "\" & dfi.NewestFileName & " (" & minutesOld & " minutes old) -- Largest File: " & dfi.LargestFileNameDir  & "\" & dfi.LargestFileName & " (" & dfi.LargestFileSizeBytes & "Bytes)")
			End if
